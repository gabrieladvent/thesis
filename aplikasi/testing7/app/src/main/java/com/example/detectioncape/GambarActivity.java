...
import com.example.detectioncape.ml.BestFloat32;
...
public class GambarActivity extends AppCompatActivity
{
    ...
    private void getPredictions() {
        ...
        float[] locations = outputs.getOutputAsTensorBuffer().getFloatArray();
        float[] classes = outputs.getOutputAsTensorBuffer().getFloatArray();
        float[] scores = outputs.getOutputAsTensorBuffer().getFloatArray();
        float[] numberOfDetections = outputs.getOutputAsTensorBuffer().getFloatArray();
